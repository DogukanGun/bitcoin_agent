...
export interface IPaymentPointNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface IPaymentPointNFT extends BaseContract {
  connect(runner?: ContractRunner | null): IPaymentPointNFT;
  waitForDeployment(): Promise<this>;

  interface: IPaymentPointNFTInterface;
